...
if fileexists("probelog.txt")
    ...
    if input = 0
        M30 "probelog.txt"
        echo >"probelog.txt" "=========================================="
        echo >>"probelog.txt" "MACRO VALIDAZIONE PROBE"
        echo >>"probelog.txt" "Data: ", today
        echo >>"probelog.txt" "=========================================="
    else
        echo >>"probelog.txt" " "
        echo >>"probelog.txt" "=========================================="
        echo >>"probelog.txt" "NUOVA VALIDAZIONE PROBE"
        echo >>"probelog.txt" "Data: ", today
        echo >>"probelog.txt" "=========================================="
else
    echo >"probelog.txt" "=========================================="
...
echo "=========================================="
echo >>"probelog.txt" "AVVIO VALIDAZIONE PROBE: ", state.time
...
echo "=========================================="
echo >>"probelog.txt" "FASE 1: INIZIALIZZAZIONE - Tool deselezionato, Stato probe:", sensors.probes[0].value[0]
...
if sensors.probes[0].value[0] = 1000
    ...
    echo "=========================================="
    echo >>"probelog.txt" "FASE 2: VERIFICA STATO PROBE - Probe INATTIVO (1000), esecuzione movimento sicuro"
    ...
    echo >>"probelog.txt" "Movimento sicuro Z:50mm completato, limiti software ripristinati"
else
    echo "=========================================="
    echo "FASE 2: VERIFICA STATO PROBE"
    ...
    echo "=========================================="
    echo >>"probelog.txt" "FASE 2: VERIFICA STATO PROBE - Probe ATTIVO, valore:", sensors.probes[0].value[0]
endif
...
echo "=========================================="
echo >>"probelog.txt" "FASE 3: VERIFICA HOMING - X:", move.axes[0].homed ? "SI" : "NO", " Y:", move.axes[1].homed ? "SI" : "NO", " Z:", move.axes[2].homed ? "SI" : "NO"
...
if move.axes[0].homed != true || move.axes[1].homed != true || move.axes[2].homed != true
    ...
    echo >>"probelog.txt" "Esecuzione homing richiesta"
    M291 P"Homing assi necessario. Avvio procedura..." R"Homing" S0 T5
    G28
    echo "Homing completato con successo"
    echo >>"probelog.txt" "Homing completato con successo a ", state.time
else
    echo "Tutti gli assi già in home"
    echo >>"probelog.txt" "Tutti gli assi già in posizione home"
endif
...
echo "=========================================="
echo >>"probelog.txt" "FASE 4: POSIZIONAMENTO INIZIALE - X:500 Y:300, motore C disabilitato"
...
echo "=========================================="
echo >>"probelog.txt" "FASE 5: CONFIGURAZIONE PROBE K0 - Trigger:-3 Z:", move.axes[2].machinePosition
...
echo "=========================================="
echo >>"probelog.txt" "FASE 6: CONFIGURAZIONE PROBE K1 - Sensibilità1:0.5 Sensibilità2:-1"
...
echo "=========================================="
echo >>"probelog.txt" "FASE 7: VALIDAZIONE FINALE - X:550 Y:300 Z:", move.axes[2].machinePosition
...
echo "=========================================="
echo >>"probelog.txt" "FASE 8: RIPRISTINO CONFIGURAZIONE - Parametri ripristinati"
...
echo >>"probelog.txt" "=========================================="
echo >>"probelog.txt" "RIEPILOGO FINALE VALIDAZIONE PROBE"
echo >>"probelog.txt" "Stato: Procedura completata con successo"
echo >>"probelog.txt" "Probe K0: Configurato con trigger height -3"
echo >>"probelog.txt" "Probe K1: Configurato con sensibilità 0.5/-1"
echo >>"probelog.txt" "Posizione finale: X550 Y300"
echo >>"probelog.txt" "Data completamento: ", state.time
echo >>"probelog.txt" "=========================================="
