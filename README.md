...
**Note**: 32 bit images should be built from the `bookworm` branch.
64 bit images should be built from the `bookworm-arm64` branch.
...
touch ./stage0/SKIP ./stage1/SKIP ./stage2/SKIP ./stage-dsf/SKIP ./stage3/SKIP ./stage4/SKIP ./stage5/SKIP 
