...
M569 P71.0 S0 D4                         ; driver 71.0 goes forwards (Y axis)
M569 P72.0 S0 D4                         ; driver 72.0 goes forwards (Y axis)
...
M906 X2500 Y2500 Z2500 C2000                           ; set axis driver currents
M92 X100 Y100 Z640 C200                           ; configure steps per mm
M208 X-30:1100 Y-10:600 Z0:620 C-2:70                          ; set minimum and maximum axis limits
...
; Probes
M558 A2 Z1 K0 B0 P5 C"io4.in" H50 F500:250 T9000 R1             ; set Z probe type to bltouch and the dive height + speeds
;M558 K1 P11 C"60.i2c.ldc1612" F3000 T3000
;M558.2 K1 S21 R140595
G31 K0 P500 X0 Y-41 Z0.6
;G31 K1 X0 Y-31 Z5

; Mesh Bed Compensation
M557 X40:1050 Y30:550 P10:5             ; define grid for mesh bed compensation
